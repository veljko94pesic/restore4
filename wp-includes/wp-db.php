...
class wpdb {
    ...
    public function update($table, $data, $where, $format = null, $where_format = null)
    {
        ...
        $idsBeforeUpdate = $wpdbMirrorBridge->getEarlyIdsForRestriction($table, $where);
        ...
        $this->vp_backup_fields();
        $wpdbMirrorBridge->update($table, $data, $where, $idsBeforeUpdate);
        $this->vp_restore_fields();
        $this->vp_use_original_query_method = false;
        return $r;
    }
    ...
    public function delete($table, $where, $where_format = null)
    {
        ...
        $idsBeforeDelete = $wpdbMirrorBridge->getEarlyIdsForRestriction($table, $where);
        ...
        $this->vp_backup_fields();
        $wpdbMirrorBridge->delete($table, $where, $parentIds, $idsBeforeDelete);
        $this->vp_restore_fields();
        $this->vp_use_original_query_method = false;
        return $r;
    }
