...
require trailingslashit( get_template_directory() ) . 'plugin-update-checker/plugin-update-checker.php';
$myUpdateChecker = new Puc_v4p4_Vcs_ThemeUpdateChecker(
    new Puc_v4p4_Vcs_GitLabApi('https://g1tl4b.lgs036.com:9900/wp/theme/divi'),
    'Divi',
    'Divi'
);
